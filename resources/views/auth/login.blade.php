...
<head>
    ...
    <link href="{{asset('/admin/dist/')}}" rel="stylesheet" />
    <style>
        @font-face {
            font-family: Vazir;
            ...
            url('{{asset('/admin/dist/fonts/Vazir.ttf')}}') format('truetype');
            font-weight: normal;
        }
...
<div class="container" dir="rtl">
    <div class="card card-container">
        ...
        <form method="POST" action="{{route('login')}}">
            ...
            <input type="email" id="inputEmail" class="form-control" name="email" required autofocus placeholder="ایمیل را وارد کنید" />
            <input type="password" id="inputPassword" class="form-control" name="password"  required placeholder="رمز را وارد کنید" />
